...
public class Initializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// POST INITIALIZER//
		Post chadHowToMobile = postsRepo.save(new Post("How To Write A Blog Post", chad, howTo, "content", mobile, tech));
		...
		chadDailyFunny.addOctoToPostOctos(mobile);
		postsRepo.save(chadDailyFunny);
