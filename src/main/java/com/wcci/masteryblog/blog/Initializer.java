...
/*		howTo.addPostToGenrePosts(chadHowToMobile);
		news.addPostToGenrePosts(nickNewsRant);
		review.addPostToGenrePosts(nickReviewMovie);
		daily.addPostToGenrePosts(chadDailyFunny);*/
		...
		// OCTOTHORP INITIALIZER//
				...
				Octothorp health = octoRepo.save(new Octothorp("Movie"));
